...
import PaymentList from './components/payment-pending-list';
import PaymentPendingList from './components/payment-pending-list';
          ...
          <div className="py-8 sm:flex sm:items-center">
            <div className="sm:flex-auto">
              ...
              <p className="mt-2 text-sm text-gray-700">
                Autoriza los pagos realizados por los almacenes
              </p>
            </div>
