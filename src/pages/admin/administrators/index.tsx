...
const Administrators = () => {
  ...
  useEffect(() => {
    if (user !== null) {
      fetch(endPoints.reports.getUsers('ADMINISTRATOR'), {
        headers: {
  ...
  const Filters = (clave: any, filtro: any) => {
    ...
    if (user !== null) {
      fetch(endPoints.reports.getUsers('ADMINISTRATOR') + url, {
        headers: {
          Authorization: 'Bearer ' + user.token,
        },
      })
          ...
          <div className="py-8 sm:flex sm:items-center">
            <div className="sm:flex-auto">
              ...
              <p className="mt-2 text-sm text-gray-700">
                Listado global de usuarios tipo administrador
              </p>
            </div>
                    ...
                    <div className="w-full bg-white mx-auto ">
                      <div className=" mt-2">
                        <div className="min-w-full overflow-x-auto lg:h-full min-h-full sm:h-full overflow-hidden rounded-lg">
                          ...
                          <br></br>
                          <br></br>
                          <Table tableRef={tableRef} data={users} />
                        </div>
                      </div>
                    </div>
                  </div>
