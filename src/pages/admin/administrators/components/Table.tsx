...
const Table = ({ data, tableRef }: { data: any; tableRef: any }) => {
  ...
  const activeSC = ({ values }: { values: any }) => {
        ...
        <tbody className="divide-y divide-gray-200 bg-white">
          {Object.values(temp).map((s: any, index) => (
            <tr key={index} className="bg-white">
              <td className="whitespace-nowrap py-4 pl-3 pr-4 text-left text-sm font-normal text-gray-600 sm:text-xs">
                {s.dpi}
              </td>
