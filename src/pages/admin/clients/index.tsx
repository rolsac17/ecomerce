...
const Clients = () => {
  ...
  useEffect(() => {
    if (user !== null) {
      fetch(endPoints.reports.getUsers('CLIENT_USER'), {
        headers: {
  ...
  const Filters = (clave: any, filtro: any) => {
    ...
    filter.forEach((f: any, index: any) => {
      if (index === 0) {
    ...
    if (user !== null) {
      fetch(endPoints.reports.getUsers('CLIENT_USER') + url, {
        headers: {
          Authorization: 'Bearer ' + user.token,
        },
      })
      ...
      <div className="h-full max-w-7xl mx-auto px-4 sm:px-6 md:px-8 ">
        ...
        <div className="px-4  sm:px-6 lg:px-8">
          <div className="py-8 sm:flex sm:items-center">
            <div className="sm:flex-auto">
              ...
              <p className="mt-2 text-sm text-gray-700">
                Listado general de usuarios tipo cliente
              </p>
            </div>
          ...
          <div className="mx-4 mt-5 rounded-2xl border-1 border-gray-50  bg-gray-100 border-rounded  h-auto shadow-sm  ring-gray-100 sm:-mx-6 md:mx-0 md:rounded-lg">
            <div>
              <div className="">
                <div className="bg-white w-full h-auto   border-rounded px-6 rounded-lg shadow-2xl shadow-gray-300">
