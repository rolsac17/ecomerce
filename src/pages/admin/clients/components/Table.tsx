      ...
      >
        <thead>
          <tr className="bg-gray-100">
            ...
            <th
              scope="col"
              className=" py-3.5 pr-3 text-left px-3 sm:hidden text-sm sm:text-xs font-semibold text-gray-900"
            >
              Teléfono
            </th>
            <th
        ...
        <tbody className="divide-y divide-gray-200 bg-white">
          {Object.values(temp).map((s: any, index: any) => (
            <tr key={index} className="bg-white">
              <td className="whitespace-nowrap py-4 pl-4 pr-3 text-sm sm:text-xs sm:pl-6">
              ...
              <td className="whitespace-nowrap sm:hidden py-4 pl-3 pr-4 text-left text-sm sm:text-xs font-normal text-gray-600">
                {s.cellPhone}
              </td>
