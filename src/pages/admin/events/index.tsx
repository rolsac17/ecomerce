...
const Events = () => {
  ...
  const getEvents = () => {
    if (user !== null) {
      fetch(endPoints.events.getEvents, {
        headers: {
        ...
        <div className="px-4  sm:px-6 lg:px-8">
          <div className="py-8 sm:flex sm:items-center">
            <div className="sm:flex-auto">
              <h1 className="text-3xl font-semibold text-gray-900">Eventos</h1>
              <p className="mt-2 text-sm text-gray-700">
               Crea tus eventos para agregar tus wish list
              </p>
            </div>
