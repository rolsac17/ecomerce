            ...
            >
              <div className="flex-1 flex flex-col bg-white p-4">
                ...
                <div className="w-full h-48 my-2 p-2 bg-gray-50 rounded-md">
                  ...
                  <dd className="text-gray-400 text-xs">
                    Q {parseFloat(o.totalAmount).toFixed(2).replace(/\d(?=(\d{3})+\.)/g, '$&,')}
                  </dd>
                </div>
                ...
                <button
                  ...
                  className="w-full p-2 my-6 bg-cblue-500 text-sm text-white font-medium rounded-md hover:bg-cblue-100"
                >
                  Ver detalle
                </button>
              </div>
