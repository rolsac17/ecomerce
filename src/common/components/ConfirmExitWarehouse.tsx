  ...
  return (
    <div className="sm:mx-auto sm:w-full sm:max-w-md px-4">
      <div className="flex justify-center items-center flex-col">
        ...
        <p className="mt-2 text-base text-center leading-6 font-normal text-gray-900">
          Bienvenido a la familia más grande de Guatemala. Recibimos tu
          información correctamente y nos comunicaremos contigo a la brevedad
          posible.
        </p>
        <button
...
export default ConfirmExitWarehouse;
